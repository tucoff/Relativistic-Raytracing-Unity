...
public class RayTracingManager : MonoBehaviour
{
    ...
    void OnGUI()
    {
        if (showFPS)
        {
            ...
            string rayTracingInfo = string.Format("Triangles: {0} | Meshes: {1}", 
                numTriangles, numMeshChunks);
    ...
    void OnRenderImage(RenderTexture src, RenderTexture target)
    {
        ...
        {
            // Inicializa e configura os dados necessários
            InitFrame();
            
            // Simplesmente executa o shader de ray tracing e envia o resultado direto para a tela
    ...
    {
        // Apenas parâmetros necessários para o shader primitivo
        // Todos os parâmetros de múltiplos raios, bounces, e ambiente foram removidos
        // porque não são mais utilizados
    }
    ...
    void OnValidate()
    {
        // Removido validações de parâmetros não mais utilizados
    }
}