...
public class CurvedLineRelativisticGenerator : MonoBehaviour
{
    ...
    public float gravitationalConstant = 1.0f; // G
    public float speedOfLight = 10.0f;         // c (Ajuste isso para ver mais/menos curvatura na escala do jogo)
